        ...
        <div class="right-column-content">
                    ...
                    <?php if($numb == 1): ?>
                      ...
                      <div class="product-content">
                        <div class="image-content">
                          ...
                          <img class="d-block w-100" src="<?php echo e(get_image_url( $row['post_image_url'] )); ?>" alt="<?php echo e(basename( get_image_url( $row['post_image_url'] ) )); ?>" />
                          <?php else: ?>
                          <img class="d-block w-100" src="<?php echo e(default_placeholder_img_src()); ?>" alt="" />
                          <?php endif; ?>
                        </div>
                        <div class="product-details">
                          <p><a href="<?php echo e(route('details-page', $row['post_slug'])); ?>"><?php echo $row['post_title']; ?></a></p>
          ...
          <div class="advertisement">
            ...
            <div class="advertisement-content text-center">
              <img class="d-block w-100" src="<?php echo e(asset('public/images/add-sample/shipping.jpg')); ?>" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="advertisement-right">
            <div id="advertisement-right-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <div class="text-center">
                    <a href=""><img src="<?php echo e(asset('public/images/add-sample/girl.jpg')); ?>" alt="" class="d-block w-100" /></a>
                  </div>
                </div>
                <div class="carousel-item">
                  <div class="text-center">
                    <a href=""><img src="<?php echo e(asset('public/images/add-sample/sunglass.png')); ?>" alt="" class="d-block w-100" /></a>
                  </div>
                </div> 
                <div class="carousel-item">
                  <div class="text-center">
                    <a href=""><img src="<?php echo e(asset('public/images/add-sample/mobile.png')); ?>" alt="" class="d-block w-100" /></a>
                  </div>
                </div>
              </div>
              <div class="slider-control-main text-center">
