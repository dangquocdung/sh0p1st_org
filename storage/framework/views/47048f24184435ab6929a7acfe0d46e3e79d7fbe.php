  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box-body">
        ...
        <div class="form-group">
          <div class="row">   
            <label class="col-sm-4 control-label" for="inputCurrencyConversionMethod"><?php echo e(trans('admin.currency_conversion_method_label')); ?></label>
            <div class="col-sm-8">
              ...
              <input type="radio" checked="checked" class="shopist-iCheck" name="CurrencyConversionMethod" value="fixer_api"> <?php echo trans('admin.currency_conversion_method_fixer_label'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
              <?php } else {?>
              <input type="radio" class="shopist-iCheck" name="CurrencyConversionMethod" value="fixer_api"> <?php echo trans('admin.currency_conversion_method_fixer_label'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
              <?php }?>
              ...
              <input type="radio" checked="checked" class="shopist-iCheck" name="CurrencyConversionMethod" value="custom"> <?php echo trans('admin.currency_conversion_method_custom_label'); ?>

              <?php } else {?>
              <input type="radio" class="shopist-iCheck" name="CurrencyConversionMethod" value="custom"> <?php echo trans('admin.currency_conversion_method_custom_label'); ?>
        ...
        <div class="form-group">
          <div class="row">   
            <label class="col-sm-4 control-label" for="inputFrontendCurrency"><?php echo e(trans('admin.frontend_currency')); ?> <br>[<i style="font-size: 11px;"><?php echo trans('admin.frontend_currency_msg'); ?></i>]</label>
            <div class="col-sm-8">
              <div class="row">
                <?php $count = 1;?>  
                <?php if(count(get_available_currency_name())>0): ?>
                  ...
                  <?php }?>  
                    ...
                    <div class="col-md-6"><input type="checkbox" class="shopist-iCheck" checked="checked" name="selected_currency_for_frontend[]" id="selected_currency_for_frontend" value="<?php echo e($currency_code); ?>">&nbsp;<?php echo e($currency_name); ?></div>
                    <?php else: ?>
                      <div class="col-md-6"><input type="checkbox" class="shopist-iCheck" name="selected_currency_for_frontend[]" id="selected_currency_for_frontend" value="<?php echo e($currency_code); ?>">&nbsp;<?php echo e($currency_name); ?></div>
                    <?php endif; ?>
