...
<?php $__env->startSection('content'); ?>
  <div id="checkout_page" class="container">
            ...
            <div class="checkout-content">
                  ...
                  <ul class="cart-data">
                    ...
                    <li class="row cart-button-main">
                      <div class="apply-coupon">
                        ...
                        <button class="btn btn-secondary" name="apply_coupon_post" id="apply_coupon_post"><?php echo trans('frontend.apply_coupon_label'); ?></button>
                        <div class="clearfix visible-xs"></div>
                      </div>
                      <div class="btn-cart-action">
                        <button class="btn btn-secondary empty" type="submit" name="empty_cart" value="empty_cart"><?php echo e(trans('frontend.empty_cart')); ?></button>
                        <button class="btn btn-secondary update" type="submit" name="update_cart" value="update_cart"><?php echo e(trans('frontend.update_cart')); ?></button>
                      </div>
                    </li>
              ...
              <div id="user_mode" class="step well">
                ...
                <div class="checkout-process-user-mode">
                  <ul class="nav">
                    <?php if($_settings_data['general_settings']['checkout_options']['enable_guest_user'] == true && $is_user_login == false): ?>  
                      <li>
                    ...
                    <?php if($_settings_data['general_settings']['checkout_options']['enable_login_user'] == true): ?>
                      <li>
                  ...
                  <div class="login-information clearfix">
                    <div class="login-content-sub">
                      ...
                      <div class="form_content">
                        ...
                        <a class="btn btn-secondary" href="<?php echo e(route('user-registration-page')); ?>"><?php echo trans('frontend.create_account_label'); ?></a>
                      </div>
                    </div>
                    <div class="login-content-sub">
                      ...
                      <div class="form_content">
                        ...
                        <a class="btn btn-secondary" href="<?php echo e(route('user-login-page')); ?>"><?php echo trans('frontend.signin_account_label'); ?></a>
                      </div>
                    </div>
                  </div>  
                </div>
              ...
              <div id="login_user_address" class="step well">
                ...
                <div class="text-right">
                  <?php if(!empty($login_user_account_data) && !empty($login_user_account_data->address_details)): ?>
                    <a href="<?php echo e(route('my-address-edit-page')); ?>" class="btn btn-secondary btn-sm"><?php echo e(trans('frontend.edit_address')); ?></a>
                  <?php else: ?>
                    <a href="<?php echo e(route('my-address-add-page')); ?>" class="btn btn-secondary btn-sm"><?php echo e(trans('frontend.add_address')); ?></a>
                  <?php endif; ?>
                </div>
                <br>
                <div class="user-address-content">
              ...
              <br>
              <button class="action next btn btn-secondary"><?php echo trans('frontend.proceed_to_checkout_label'); ?></button>
              <button name="checkout_proceed" class="action submit btn btn-secondary place-order" type="submit" value="checkout_proceed"><?php echo e(trans('frontend.place_order')); ?></button>
            </div>
          </div>  
        </div>    
      ...
      <?php else: ?>
        ...
        <div class="cart-return-shop"><a class="btn btn-secondary check_out" href="<?php echo e(route('shop-page')); ?>"><?php echo e(trans('frontend.return_to_shop')); ?></a></div>
      <?php endif; ?>
  </div>
