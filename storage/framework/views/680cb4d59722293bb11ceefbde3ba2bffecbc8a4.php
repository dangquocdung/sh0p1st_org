<div id="single_product">
  <div class="container">
    <div class="small-product-title"><h1 class="product-title"><?php echo e($single_product_details['post_title']); ?></h1><hr></div> 
    
    <?php if(!empty($single_product_details['_product_related_images_url']->shop_banner_image)): ?>  
    <div class="row extra-margin-bottom">
      <div class="col-12">
        <img src="<?php echo e(get_image_url($single_product_details['_product_related_images_url']->shop_banner_image)); ?>" class="d-block w-100" alt="" />
      </div>
    </div> 
    <?php endif; ?>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="product-main-content">
          <div class="product-main-image">
            ...
            <?php else: ?>
            <div class="product-details-no-image"><img src="<?php echo e(default_placeholder_img_src()); ?>" alt=""></div>
            <?php endif; ?>
          </div>
      ...
      <div class="col-xs-12 col-sm-7 col-md-7">
        <h1 class="product-title large-product-title"><?php echo e($single_product_details['post_title']); ?></h1>
        ...
        <?php if(( get_product_type($single_product_details['id']) == 'simple_product' || ( ( get_product_type($single_product_details['id']) == 'customizable_product' || get_product_type($single_product_details['id']) == 'downloadable_product' ) && count(get_product_variations($single_product_details['id'])) == 0) )): ?>
          ...
          <?php else: ?>
            ...
            <button class="btn btn-light request-product" type="button"><?php echo e(trans('frontend.request_product')); ?></button>
          ...
          <?php if($single_product_details['_product_manage_stock'] == 'yes' && $single_product_details['post_stock_qty'] > 0): ?>
        ...
        <div class="product-add-to-cart-content add-to-cart-content">
          <ul>
            <li>
              <div class="input-group">
                  ...
                  <input type="text" id="quantity" name="quant[1]" class="form-control input-number" value="1" min="1" max="<?php echo e($qty); ?>"/>
                  <span class="input-group-btn">
          ...
          <input type="hidden" name="available_stock_val" id="available_stock_val" value="<?php echo e($single_product_details['post_stock_qty']); ?>">
          <input type="hidden" name="backorder_val" id="backorder_val" value="<?php echo e($single_product_details['_product_manage_stock_back_to_order']); ?>">
        </div>
        <?php endif; ?>
        ...
        <div class="single-page-btn">
          <ul>
            <li>
              <a href="" class="btn btn-light btn-sm product-wishlist" data-id="<?php echo e($single_product_details['id']); ?>"><i class="fa fa-heart"></i> <?php echo e(trans('frontend.add_to_wishlist_label')); ?></a>
            </li>
            <li>
              <a href="" class="btn btn-light btn-sm product-compare" data-id="<?php echo e($single_product_details['id']); ?>"><i class="fa fa-exchange"></i> <?php echo e(trans('frontend.add_to_compare_list_label')); ?></a>
            </li>
          </ul>  
        </div>
        ...
        <div class="product-share-content">
          <ul>
            <li><a class="facebook btn btn-light btn-sm" data-name="fb" href="#" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('frontend.share_with_fb_label')); ?>"><i class="fa fa-facebook"></i> <?php echo trans('frontend.share_label'); ?></a></li>
            <li><a class="twitter btn btn-light btn-sm" data-name="tweet" href="#" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('frontend.share_with_twitter_label')); ?>"><i class="fa fa-twitter"></i> <?php echo trans('frontend.tweet_label'); ?></a></li>
            <li><a class="google-plus btn btn-light btn-sm" data-name="gplus" href="#" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('frontend.share_with_google_plus_label')); ?>"><i class="fa fa-google-plus"></i> <?php echo trans('frontend.share_label'); ?></a></li>
            <li><a class="linkedin btn btn-light btn-sm" data-name="lin" href="#" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('frontend.share_with_linkedin_label')); ?>"><i class="fa fa-linkedin"></i> <?php echo trans('frontend.share_label'); ?></a></li>
            <li><a class="pinterest btn btn-light btn-sm" data-name="pi" href="#" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('frontend.share_with_pin_it_label')); ?>"><i class="fa fa-pinterest"></i> <?php echo trans('frontend.share_pin_it_label'); ?></a></li>
            <li><a class="print btn btn-light btn-sm" data-name="print" href="#" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('frontend.print_label')); ?>"><i class="fa fa-print"></i> <?php echo trans('frontend.print_label'); ?></a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-12">  
          <ul class="nav nav-tabs">
            <li class="nav-item"><a <?php if(!old('comments_target')){?>class="nav-link active" <?php }?> href="#features" data-toggle="tab"><?php echo e(trans('frontend.features_label')); ?></a></li>  
            <li class="nav-item"><a class="nav-link" href="#shippingInfo" data-toggle="tab"><?php echo e(trans('frontend.shipping_info_label')); ?></a></li>

            <?php if($single_product_details['_product_enable_reviews'] == 'yes'): ?>
              <li class="nav-item"><a class="nav-link <?php if(old('comments_target')){?>active <?php }?>" href="#reviews" data-toggle="tab"><?php echo e(trans('frontend.reviews_label')); ?> (<?php echo $comments_rating_details['total']; ?>)</a></li>
            <?php endif; ?>

            <?php if( count(get_vendor_details_by_product_id($single_product_details['id'])) >0 ): ?>
            <li class="nav-item"><a class="nav-link" href="#vendorInfo" data-toggle="tab"><?php echo e(trans('frontend.vendor_info_label')); ?></a></li>
            <?php endif; ?>
          </ul>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="shippingInfo" >
              <?php echo trans('frontend.no_shippingInfo_label'); ?>
