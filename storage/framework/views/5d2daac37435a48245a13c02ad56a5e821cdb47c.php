  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="appearance_menu_list"> 
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active" data-target="settings"><a class="nav-link" href="#"><?php echo e(trans('admin.appearance_menu_name_settings')); ?></a></li>  
        <li class="nav-item" data-target="header"><a class="nav-link" href="#"><?php echo e(trans('admin.appearance_menu_name_header')); ?></a></li> 
        <li class="nav-item" data-target="home"><a class="nav-link" href="#"><?php echo e(trans('admin.appearance_menu_name_home')); ?></a></li> 
        <li class="nav-item" data-target="products"><a class="nav-link" href="#"><?php echo e(trans('admin.appearance_menu_name_products')); ?></a></li> 
        <li class="nav-item" data-target="single_product"><a class="nav-link" href="#"><?php echo e(trans('admin.appearance_menu_name_single_products')); ?></a></li> 
        <li class="nav-item" data-target="blogs"><a class="nav-link" href="#"><?php echo e(trans('admin.appearance_menu_name_blogs')); ?></a></li> 
      </ul> 
    </div> 
  </div> 
</nav>
                ...
                <div class="row">    
                  ...
                  <div class="col-sm-8">
                    ...
                    <div class="uploaded-header-slider-images">
                      ...
                      <div class="sample-img" style="display:none;"><img class="upload-icon" src="<?php echo e(default_upload_sample_img_src()); ?>"></div>
                      <div class="uploaded-slider-images" style="display:block;">
                        <?php $__currentLoopData = get_appearance_header_settings_data(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider_img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="header-slider-image-single-container <?php echo e(substr(basename($slider_img->img_url), 0, -4)); ?>"><img src="<?php echo e(get_image_url($slider_img->img_url)); ?>"><div data-id="<?php echo e($slider_img->id); ?>" class="remove-frontend-img-link" style="display: none;"></div></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </div>
                      <?php else: ?>
                      <div class="sample-img"><img class="upload-icon" src="<?php echo e(default_upload_sample_img_src()); ?>"></div>
...
<!--              <div class="form-group">
              ...
              <div class="form-group">
                <div class="row">    
                  <label class="col-sm-4 control-label" for="inputHeaderCustomCSS"><?php echo e(trans('admin.custom_css_use')); ?><br><i style="font-size:12px;"><?php echo e(trans('admin.compitable_label')); ?></i></label>
                  <div class="col-sm-8">
...
<!--                <div class="form-group">
                    ...
                    <?php else: ?>
                      <div class="manage-template clearfix">
                        ...
                        <span class="pull-right">
                          <a href="" class="btn btn-default btn-sm activate-templates" name="activate_templates" data-tab_name="header" data-template_name="<?php echo e($val); ?>" id="activate_templates"><?php echo e(trans('admin.appearance_template_activated_text')); ?></a>
                        </span>
                      </div>
                    <?php endif; ?>
                  </div>
                  ...
                  <div class="sample-img-content">
                    ...
                    <?php else: ?>
                      <div class="manage-template clearfix">
                        <span><?php echo ucwords(str_replace('-', ' ', $val)); ?></span>
                        <span class="pull-right">
                          <a href="" class="btn btn-default btn-sm activate-templates" name="activate_templates" data-tab_name="home" data-template_name="<?php echo e($val); ?>" id="activate_templates"><?php echo e(trans('admin.appearance_template_activated_text')); ?></a>
                        </span>
                      </div>
                    <?php endif; ?>
                  </div>
                  ...
                  <div class="sample-img-content">
                    ...
                    <?php else: ?>
                      <div class="manage-template clearfix">
                        <span><?php echo ucwords(str_replace('-', ' ', $val)); ?></span>
                        <span class="pull-right">
                          <a href="" class="btn btn-default btn-sm activate-templates" name="activate_templates" data-tab_name="products" data-template_name="<?php echo e($val); ?>" id="activate_templates"><?php echo e(trans('admin.appearance_template_activated_text')); ?></a>
                        </span>
                      </div>
                    <?php endif; ?>
                  </div>
                  ...
                  <div class="sample-img-content">
                    ...
                    <?php else: ?>
                      <div class="manage-template clearfix">
                        <span><?php echo ucwords(str_replace('-', ' ', $val)); ?></span>
                        <span class="pull-right">
                          <a href="" class="btn btn-default btn-sm activate-templates" name="activate_templates" data-tab_name="single_product" data-template_name="<?php echo e($val); ?>" id="activate_templates"><?php echo e(trans('admin.appearance_template_activated_text')); ?></a>
                        </span>
                      </div>
                    <?php endif; ?>
                  </div>
                  ...
                  <div class="sample-img-content">
                    ...
                    <?php else: ?>
                      <div class="manage-template clearfix">
                        <span><?php echo ucwords(str_replace('-', ' ', $val)); ?></span>
                        <span class="pull-right">
                          <a href="" class="btn btn-default btn-sm activate-templates" name="activate_templates" data-tab_name="blogs" data-template_name="<?php echo e($val); ?>" id="activate_templates"><?php echo e(trans('admin.appearance_template_activated_text')); ?></a>
                        </span>
                      </div>
                    <?php endif; ?>
                  </div>
      ...
      <div class="modal fade" id="addDynamicTextOnImage" tabindex="-1" role="dialog" aria-labelledby="updater" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <p class="no-margin"><?php echo trans('admin.appearance_add_text_and_css'); ?></p>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>      
