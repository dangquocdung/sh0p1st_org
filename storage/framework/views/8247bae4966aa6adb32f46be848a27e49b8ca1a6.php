      ...
      <ul class="cart-data">
        ...
        <li class="row cart-button-main">
          ...
          <div class="btn-cart-action">
            <input type="submit" name="empty_cart" class="btn btn-secondary empty" value="<?php echo e(trans('frontend.empty_cart')); ?>">  
            <input type="submit" name="update_cart" class="btn btn-secondary update" value="<?php echo e(trans('frontend.update_cart')); ?>">
          </div>
        </li>
