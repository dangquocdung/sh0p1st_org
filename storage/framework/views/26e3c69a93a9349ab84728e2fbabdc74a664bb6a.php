              ...
              <div class="tab-content">
                  ...
                  <div class="tab-pane" id="winter_collection">
                      <div class="row">
                          ...
                          <div class="col-sm-4">
                              <img src="<?php echo e(asset('public/images/add-sample/winter.jpg')); ?>" class="d-block w-100" alt="">
                          </div>
                      </div>
                  </div>
                  <div class="tab-pane" id="summer_collection">
                      <div class="row">
                          ...
                          <div class="col-sm-4">
                              <img src="<?php echo e(asset('public/images/add-sample/summer.jpg')); ?>" class="d-block w-100" alt="">
                          </div>
                      </div>  
                  </div>
