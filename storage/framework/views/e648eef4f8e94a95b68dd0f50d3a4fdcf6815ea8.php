...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title"><?php echo trans('admin.add_new_product'); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.product_list', 'all')); ?>"><?php echo trans('admin.products_list'); ?></a></h3>
        ...
        <div class="box-body product-tab-content">
          <div class="tabbable tabs-left">
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item custom-design" style="display:none;"><a class="nav-link" href="#tab_custom_design" data-toggle="tab"><?php echo trans('admin.add_design_elements'); ?></a></li>
